...
dt = 1 / 100 * 1/Hz
# ** NOTE ** The star positions randomly falling onto the pyramid are 
# restricted to a radius of 0.5 arcseconds to keep the a standard between 
# simulations 1 and 2.
modulation_radius = 1/206265
# -------------------------------------------------------------------------
...
if __name__ == "__main__":
    ...
    positions = stars.random_radius(modulation_radius*206265, N_points=N_stars) / 206265
