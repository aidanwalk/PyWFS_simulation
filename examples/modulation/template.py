...
def generate_response(points, 
    ...
    for i, WFE in enumerate(WFEs):
        print('\tWFE =', WFE, f'{i+1}/{len(WFEs)}')
        out_slope.append(average_response(points, 
                                          WFE, 
                                          WFS=WFS,
                                          N_iters=N_iters,
                                          Z=Z, 
...
def make_response_table(modulation_radii, 
                        points_generator,
                        N_stars=12,
                        input_WFE=0.1,
                        out_dir='./',
    ...
    # Take the negative of slopes since the WFS signal is upside-down and 
    # backwards
