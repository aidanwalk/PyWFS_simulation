...
aberration. Modulation is random azimuth spacing and random radius. 



Plot of the response curve: 
---------------------------
response_random_azimuth.png 

is produced by:
For each modulation point, compute the WFS response for a given input tilt. 
